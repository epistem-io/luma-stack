...
"""
Minimum working version for correlation analysis

This module provides a simple correlation analysis using earth engine built in correlation reducers 
correlation coefficient for server-side computation in Earth Engine.
"""
